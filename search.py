...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print('Nodos visitados' , visitados,' , Nodos expandidos' , visitados-1)
            return node
...
def coste_acumulado(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, Coste())

def coste_heuristico(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, Coste2(problem))
